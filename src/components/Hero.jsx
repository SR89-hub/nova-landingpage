...
const Hero = () => {
  return (
    <section className="relative min-h-screen hidden md:flex items-center justify-center bg-gradient-to-b from-[#0A0A0A] via-[#101010] to-[#0A0A0A] overflow-hidden py-16 lg:py-24 mb-4 lg:mb-6">
      ...
      <div className="absolute top-[15%] left-[8%] w-14 h-14 text-[#6BC4BC]/20 animate-revolve-1 hidden lg:block pointer-events-none z-10">
        <div className="w-full h-full animate-spin-slow">
          <Mail className="w-full h-full drop-shadow-[0_0_8px_rgba(107,196,188,0.4)]" strokeWidth={1.5} />
        </div>
      </div>
      <div className="absolute top-[20%] right-[10%] w-16 h-16 text-[#6BC4BC]/20 animate-revolve-2 hidden lg:block pointer-events-none z-10">
      ...
      <div className="absolute top-[45%] left-[5%] w-12 h-12 text-[#6BC4BC]/20 animate-revolve-5 hidden lg:block pointer-events-none z-10">
        <div className="w-full h-full animate-spin-slow">
          <ShieldCheck className="w-full h-full drop-shadow-[0_0_8px_rgba(107,196,188,0.4)]" strokeWidth={1.5} />
        </div>
      </div>
      <div className="absolute top-[50%] right-[6%] w-14 h-14 text-[#6BC4BC]/20 animate-revolve-6 hidden lg:block pointer-events-none z-10">
        <div className="w-full h-full animate-spin-slow-reverse">
          <Send className="w-full h-full drop-shadow-[0_0_8px_rgba(107,196,188,0.4)]" strokeWidth={1.5} />
        </div>
      </div>
      <div className="absolute bottom-[20%] left-[12%] w-18 h-18 text-[#6BC4BC]/20 animate-revolve-3 hidden lg:block pointer-events-none z-10">
        <div className="w-full h-full animate-spin-slow">
          <BarChart3 className="w-full h-full drop-shadow-[0_0_8px_rgba(107,196,188,0.4)]" strokeWidth={1.5} />
        </div>
      </div>
      <div className="absolute bottom-[25%] right-[8%] w-14 h-14 text-[#6BC4BC]/20 animate-revolve-4 hidden lg:block pointer-events-none z-10">
        <div className="w-full h-full animate-spin-slow-reverse">
          <Target className="w-full h-full drop-shadow-[0_0_8px_rgba(107,196,188,0.4)]" strokeWidth={1.5} />
        </div>
      </div>
      <div className="absolute bottom-[10%] right-[15%] w-12 h-12 text-[#6BC4BC]/20 animate-revolve-7 hidden lg:block pointer-events-none z-10">
        <div className="w-full h-full animate-spin-slow">
        ...
        <div className="flex flex-col items-center text-center space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-4xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1] max-w-4xl drop-shadow-2xl" style={{ fontFamily: "'Outfit', sans-serif" }}>
              Automate the Outreach , dominate the  <span className="text-[#6BC4BC]">inbox</span>
            </h1>
          </div>
